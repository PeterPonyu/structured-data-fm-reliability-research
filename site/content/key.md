...
- **Default (headline) = key included.** The leave-group-out / rolling-origin key stays in the feature matrix.
...
Visual evidence: F2 C/D, F3 C, F6 C/D, and F4 B. Both conditions remain in the page source if scripting is disabled.
